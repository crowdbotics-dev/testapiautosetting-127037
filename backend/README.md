...
## Project Structure
    ...
    ├── testapiautosetting_127037  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_127037`
...
2. Clone this repo and `cd testapiautosetting_127037`
